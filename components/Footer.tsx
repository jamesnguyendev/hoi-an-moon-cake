        ...
        <div className="mt-5 grid grid-cols-1 lg:grid-cols-4">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col text-second">
              <a href={'/bang-gia-trung-thu'}>Bảng giá bánh trung thu</a>
              <a href="/hop-banh-trung-thu">Hộp bánh trung thu</a>
              <a href="/blog/ai-cung-co-banh-ngon-ai-cung-co-qua-dep-2021">Sự Kiện trung thu</a>
              <a href="/blog/ai-cung-co-banh-ngon-ai-cung-co-qua-dep-2021">Thông tin chia sẻ</a>
            </div>
